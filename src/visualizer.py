...
class Visualizer:
    ...
    def _on_mouse_click(self, event):
        ...
        if len(self.clicked_points) >= 4:
            print("[Visualizer] Maximum 4 points reached")
            return
    ...
    def _on_compute_pressed(self, event):
        ...
        if len(self.clicked_points) != 4:
            print("[Visualizer] Exactly 4 points are required")
            return
    ...
    def _init_rviz_visualizer(self):
        print("[Visualizer] RViz mode selected (not implemented)")
